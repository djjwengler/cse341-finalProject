    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                res
                    .status(500)
                    .json(err_1.message || "Some error occurred while adding the book.");
                return [3 /*break*/, 4];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, BookModel.find({ title: title })
                        .then(function (data) {
                        res.status(200).send(data);
                    })["catch"](function (err) {
                        res.status(500).send({
...
module.exports.getByAuthor = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var author, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, BookModel.find({ author: author })
                        .then(function (data) {
                        if (data.length == 0) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, BookModel.find({ genre: genre })
                        .then(function (data) {
                        if (data.length == 0) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, BookModel.deleteOne({ _id: bookId })
                        .then(function () {
...
module.exports.update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        try {
            ...
            BookModel.findOneAndUpdate({ _id: bookId }, updateBook_1, { runValidators: true }, function (err, data) {
                if (err) {
                    res
                        .status(500)
                    ...
                    console.log("New data : ", updateBook_1);
                }
            });
        }
        catch (err) {
